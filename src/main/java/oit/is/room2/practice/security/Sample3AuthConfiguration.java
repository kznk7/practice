package oit.is.room2.practice.security;
...
public class Sample3AuthConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(AuthenticationManagerBuilder auth) throws Exception {
    ...
    auth.inMemoryAuthentication().withUser("kyaku")
        .password("$2y$10$Gf4V.gsxCgCNfPKFPnx0duhpjdbHr/h/0ENQdIrhTVPz75tuc.GiG").roles("CUSTOMER");
    auth.inMemoryAuthentication().withUser("bainin")
